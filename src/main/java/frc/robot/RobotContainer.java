...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    liftTrigger.whileTrue(climbSubsystem.runLiftCommand(()->0.25));//.alongWith(climbSubsystem.runRollerCommand(()->-0.1)));
    reverseLiftTrigger.whileTrue(climbSubsystem.runLiftCommand(()->-0.25));//.alongWith(climbSubsystem.runRollerCommand(()->0.1)));
  }
