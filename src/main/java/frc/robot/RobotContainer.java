...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    liftTrigger.whileTrue(climbSubsystem.comboLiftCommand(()->0.25,()->0.25));//.alongWith(climbSubsystem.runRollerCommand(()->-0.1)));
    reverseLiftTrigger.whileTrue(climbSubsystem.comboLiftCommand(()->-0.25,()->-.25));//.alongWith(climbSubsystem.runRollerCommand(()->0.1)));
  }
